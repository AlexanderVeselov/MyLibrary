...
| [Precomputed Radiance Transfer for Real-Time Rendering in Dynamic, Low-Frequency Lighting Environments](https://sites.fas.harvard.edu/~cs278/papers/prt.pdf) + [PRTCourse](http://www0.cs.ucl.ac.uk/staff/j.kautz/PRTCourse/) + [Normal Mappinf for PRT](https://www.ppsloan.org/publications/NMPRT.pdf) + [Deformations](https://www.ppsloan.org/publications/ldprt_final05.pdf) | Peter-Pike Sloan, Jan Kautz, John Snyder | SIGGRAPH 2002 |
